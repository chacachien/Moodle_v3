...
class __Mustache_6f2ced61931354da870272149e15c0ab extends Mustache_Template
{
...
';
        $value = $context->find('js');
        $buffer .= $this->section39e0c1973304a58afeb60c9fa9dd42b7($context, $indent, $value);
...
';
    ...
    private function section39e0c1973304a58afeb60c9fa9dd42b7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
console.log(\'kkkk\'); // to confirm the func called
});
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
...
';
                $buffer .= $indent . 'console.log(\'kkkk\'); // to confirm the func called
';
                $buffer .= $indent . '});
';
                $context->pop();
