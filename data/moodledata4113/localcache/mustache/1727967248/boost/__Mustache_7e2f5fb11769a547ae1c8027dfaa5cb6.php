...
class __Mustache_7e2f5fb11769a547ae1c8027dfaa5cb6 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section232bef4efb8a2ed572f94fb8bd2840d7($context, $indent, $value);
...
';
    ...
    private function section232bef4efb8a2ed572f94fb8bd2840d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
require([\'theme_boost/config\'], function(widgetjs) {
console.log(widgetjs); // to confirm the func called
});
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_boost/config\'], function(widgetjs) {
';
                $buffer .= $indent . 'console.log(widgetjs); // to confirm the func called
';
                $buffer .= $indent . '});
';
                $context->pop();
